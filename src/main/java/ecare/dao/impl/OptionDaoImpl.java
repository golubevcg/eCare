...
public class OptionDaoImpl implements OptionDao {
    ...
    public List<Option> getOptionByName(String name) {
        ...
        Query<Option> query = session.createQuery(
                "select o from Option o where o.name = :nam", Option.class);
    ...
    public List<Option> getOptionById(Long id) {
        Session session = sessionFactory.getCurrentSession();
        Query<Option> query = session
                .createQuery("select o from Option o where o.option_id = :id", Option.class);
    ...
    public List<Option> searchForOptionByName(String name) {
        Session session = sessionFactory.getCurrentSession();
        Query<Option> query = session.createQuery(
                "select o from Option o where o.name like:string", Option.class);
