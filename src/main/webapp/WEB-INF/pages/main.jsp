        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <button type="submit" class="btn" style="background-color:#ff9a00;color:white">Enter</button>
                </form>
            </div>
...
<div class="row" style="margin-top:10px">
    ...
    <div class="col-5">
        ...
        <img src="static/logo.png" class="rounded float-left" alt="..." style="width:65px; float:left;">
    ...
    <div class="col-5">
                ...
                <div class="jumbotron" id="switchWithOldNumberJumbotron">
                    ...
                    <div class="col" style="float:left; width: 45%">
                        <img src="static/oldPhone.png" class="rounded float-left" alt="..."
