        ...
        <div class="row">
            ...
            <div class="col-5">
                ...
                <div id="tarifOptionsForUserRegistration">
                    ...
                    <label style="color:red; float:left;" id="selectedTariffFieldRequired" hidden>This field is required.</label>
                    ...
                    <select class="mul-select" multiple="true" id="optionsList" style="width:60%; font-size: 20px" name="selectedOptions" disabled="true">
                    </select>
